				...
				<div class="col-lg-3 col-md-4">
					<div class="app-icon">
						...
						<div class="contact-app">
							<ul>
								<li><a href="#"><i class="fa flaticon-facebook"></i></a><br>Facebook </li>
								<li><a href="#"><i class="fa flaticon-twitter"></i></a><br>Twitter</li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="row justify-content-center text-center">
				<div class="col-md-12 bot-menu">
					<div class="foot-menu">
						<ul>
							...
							<li><a href="games.php">Games & How To Play</a></li>
							<li><a href="results.php">Draws & Results</a></li>
				...
				<div class="col-md-12">
					<div class="copy-right">
						<h6>Copyright 2024. All rights reserved by PesaPlays</h6>
					</div>
				</div>
			</div>
		</div>
