...
<body oncontextmenu="return false;">
    ...
    <section id="header" class="header_area">
		...
		<!-- NAV AREA CSS -->
		<nav id="nav-part" class="navbar header-nav other-nav custom_nav full_nav sticky-top navbar-expand-md ">
			<div class="container">
            ...
            <span class="navbar-toggler-icon"></span>
				...
				<div class="collapse navbar-collapse" id="navbarNav">
						...
						<ul class="nav navbar-nav m-auto menu-inner ">
							...
							<li><a href="games.php"> How To Play </a></li>
